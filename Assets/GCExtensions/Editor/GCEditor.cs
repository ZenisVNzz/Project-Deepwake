...
namespace GCGames.Editors
{
    public class GCColorHolder
    {
        ...
        public GCColorHolder(GUIStyle inputStyle)
        {
    ...
    public class GCEditor : Editor
    {
        ...
        public static void SetColorToEditorStyle(GCColorHolder label, GCColorHolder foldout)
        {
