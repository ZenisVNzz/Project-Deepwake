    ...
    public class E_WelcomeState : ScriptableObject
    {
            ...
            get
            {
                if (welcomePageInstance == null)
                {
                    ...
                    if (welcomePageInstance == null)
                    {
                        ...
                        AssetDatabase.CreateAsset(welcomePageInstance, "Assets/GCExtensions/Resources/WelcomeStatus.asset");
        ...
        public static void SaveSettings()
        {
            if (!AssetDatabase.Contains(WelcomePageInstance))
            {
                ...
                if (welcomePageInstance == null)
                {
                    AssetDatabase.CreateAsset(copy, "Assets/GCExtensions/Resources/WelcomeStatus.asset");
